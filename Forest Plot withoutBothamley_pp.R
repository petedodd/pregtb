...
res.RE <- rma(yi=yi,vi=vi,data=DRPP, subset=(Full_study=="Yes"),
...
forest(res.RE, xlim = c(-16,10), at=log(c(0.05,0.37, 1, 5)), atransf=exp,  cex=0.75, ylim=c(-1, 8),
...
text(-16,                7, "Author(s), Country and Year",  pos=4)
text(10,                 7, "Incidence Risk Ratio [95% CI]", pos=2)
