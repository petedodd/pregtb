...
pdf(file=here('metaanalysis/plots/ForestPlotWithoutBothamleyPP.pdf'))
...
forest(res.FE, xlim = c(-20,10), at=log(c(0.02, 0.25, 1, 3, 7)), atransf=exp,
       ...
       ilab.xpos=c(-11,-8.5,-6.5,-4), cex=0.75, ylim=c(-2, 9),
       ilab.pos = 2,
...
text(-20,                    7.5, "Author(s), Country and Year",  pos=4)
text(10,                     7.5, "Incidence Risk Ratio [95% CI]", pos=2)
text(c(-11.5,-9,-7,-4.5),    7.5, c("TB+", "TB-", "TB+", "TB-"))
text(c(-10.25,-5.75),        8.0, c("Postpartum", "Not postpartum"))
